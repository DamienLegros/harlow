...
py_binary(
    name = "python_harlow_old",
    srcs = ["python/meta_rl/harlow_old.py"],
    data = [":deepmind_lab.so"],
    main = "python/meta_rl/harlow_old.py",
    visibility = ["//python/tests:__subpackages__"],
    deps = ["@six_archive//:six"],
)

py_binary(
    name = "python_harlow_bad",
    srcs = ["python/meta_rl/harlow_bad.py"],
    data = [":deepmind_lab.so"],
    main = "python/meta_rl/harlow_bad.py",
    visibility = ["//python/tests:__subpackages__"],
    deps = ["@six_archive//:six"],
)

py_binary(
    name = "python_harlow_test",
    srcs = ["python/meta_rl/harlow_test.py"],
    data = [":deepmind_lab.so"],
    main = "python/meta_rl/harlow_test.py",
    visibility = ["//python/tests:__subpackages__"],
    deps = ["@six_archive//:six"],
)

py_binary(
    name = "python_harlow_train",
    srcs = ["python/meta_rl/harlow_train.py"],
    data = [":deepmind_lab.so"],
    main = "python/meta_rl/harlow_train.py",
    visibility = ["//python/tests:__subpackages__"],
    deps = ["@six_archive//:six"],
)
