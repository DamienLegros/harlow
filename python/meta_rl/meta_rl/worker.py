      ...
      while not coord.should_stop() and episode_count <= num_episodes:
        ...
        for _ in range(1):
          ...
          while d == False:
            ...
            if calibration:
                print("Calibration")
                rotation = calibration_position - self.position
                s1, r, d, t = self.env.step(np.array([rotation, 0, 0, 0, 0, 0, 0], dtype=np.intc))
            ...
            #print("episode_step_count : "+str(episode_step_count))
        ...
        if episode_count % 10 == 0 and episode_count != 0:
          ...
          if train == True and self.name == 'worker_0':
            # For Tensorboard
            #print("episodes_rewards :"+str(self.episode_rewards[-10:]))
            #print("mean_reward :"+str(np.mean(self.episode_rewards[-10:])))
