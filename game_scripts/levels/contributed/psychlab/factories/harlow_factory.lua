...
function factory.createLevelApi(kwargs)
  ...
  function env:_init(pac, opts)
    ...
    --log.info(helpers.tostring(psychlab_helpers.getUpperLeftFromCenter(kwargs.left, kwargs.targetSize / 2)))
  ...
  function env:reset(episodeId, seed)
    ...
    log.info('Episode set up, corrID=' .. self.correctID .. ', incorrID=' .. self.incorrectID)
  end
